        ...
        <div class="content-primeiro">
            <div class="hero">
                <div class="text">
                    ...
                    <p>Diversidade espiritual e a união entre os mundos</p>
                </div>                
                <div class="button">
        ...
        <div class="content-segundo">
            ...
            <div class="conteudos">
                <a href="" class="links-none">
                    <div class="conteudo" >
                        <h2 class="h2-orixa"><strong>Oxala</strong></h2>
                ...
                <a href="" class="links-none">    
                    <div class="conteudo">
                        <h2 class="h2-orixa"><strong>Yemanjá</strong></h2>
                ...
                <a href="" class="links-none">    
                    <div class="conteudo">
                        <h2 class="h2-orixa"><strong>Ogum</strong></h2>
            ...
            <div class="conteudos">
                <a href="orixas.html" class="links-none">
                    <div class="conteudo" >
                        <h2 class="h2-orixa"><strong>Oxóssi</strong></h2>
                ...
                <a href="" class="links-none">    
                    <div class="conteudo">
                        <h2 class="h2-orixa"><Strong>Xangô</Strong></h2>
                ...
                <a href="" class="links-none">    
                    <div class="conteudo">
                        <h2 class="h2-orixa"><strong>Iansã</strong></h2>
            ...
            <div class="conteudos">
                <a href="orixas.html" class="links-none">
                    <div class="conteudo" >
                        <h2 class="h2-orixa"><strong>Oxum</strong></h2>
                ...
                <a href="" class="links-none">    
                    <div class="conteudo">
                        <h2 class="h2-orixa"><strong>Obaluaiê</strong></h2>
                ...
                <a href="" class="links-none">    
                    <div class="conteudo">
                        <h2 class="h2-orixa"><strong>Nanã</strong></h2>
